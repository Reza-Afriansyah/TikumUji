...
// ==================== AUTO CLEANUP SYSTEM UNTUK MINI SOCCER - DIPERBAIKI ====================
const AutoCleanupSystem = {
    ...
    init() {
        ...
        console.log('🔄 Auto Cleanup System initialized for Mini Soccer');
    ...
    performAutoCleanup() {
        try {
            ...
            if (changesMade) {
                ...
                console.log(`🧹 Auto cleanup: ${completedCount} mini soccer bookings marked as completed`);
...
// Real-time Data Sync Manager untuk Mini Soccer
const DataSyncManager = {
    ...
    init() {
        ...
        console.log('🔄 Real-time Data Sync Manager initialized for Mini Soccer');
    },
...
function updateQuickStats() {
    try {
        ...
        console.log('📊 Quick Stats Updated:', {
            ...
            totalActiveBookings,
            completedToday,
            totalReservations: minisoccerReservations.length
        });
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('✅ Mini Soccer Booking Page loaded successfully with Auto Cleanup and Horizontal Scroll!');
});
